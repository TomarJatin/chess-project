                            ...
                            >
                                <View style={{
                                    ...
                                    <Image
                                        ...
                                        />
                                        <View>
                                            <Text style={{color: Color.textColor, fontSize: FontSize.xs13, fontWeight: "800"}}>Player 2</Text>
                            ...
                            >
                                <View style={{
                                    ...
                                    <Image
                                        ...
                                        />
                                        <View>
                                            <Text style={{color: Color.textColor, fontSize: FontSize.xs13, fontWeight: "800"}}>Player 1</Text>
                                            <Text style={{color: Color.textColor, fontSize: FontSize.xxs, fontWeight: "400", marginTop: 3}}>00:60</Text>
                                        </View>
                                        <Image
                                            style={{
